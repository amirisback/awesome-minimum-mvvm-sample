...
<table>
  ...
  <tr>
    <td>1.</td>
    <td><a href="https://github.com/amirisback/minimum-mvvm-hilt">Simple</a></td>
    <td>Simple Sample MVVM</td>
  </tr>
  <tr>
    <td>2.</td>
    <td><a href="https://github.com/amirisback/minimum-mvvm-hilt-network-api">HTTP Request</a></td>
    <td>MVVM with simple HTTP Request Example</td>
  </tr>
    <tr>
    <td>3.</td>
    <td><a href="https://github.com/amirisback/minimum-mvvm-hilt-room-database">Room Database</a></td>
    <td>MVVM With Simple Room Database</td>
  </tr>
